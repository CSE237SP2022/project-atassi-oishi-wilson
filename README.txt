...
At the moment, all our project is able to do is parse a simple CSV file. In the next iteration, we plan to use the parsed values of the input CSV file to create BudgetItem and Budget objects for the user to accurately represent their expenses and print them to the user so they can be visualized as well. 
